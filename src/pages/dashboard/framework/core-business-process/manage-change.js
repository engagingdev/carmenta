...
const slides = [
    {
        ...
        url: 'https://player.vimeo.com/video/898794510?h=e3608b2820&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
    },
    {
        text: <>Shannon Armstrong & Whit Bernard</>,
        img: '/images/thumbnails/s-w-y.png',
        url: 'https://player.vimeo.com/video/898794648?h=247c583e0f&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
    },
    {
        text: <>Meena Rao</>,
        img: '/images/thumbnails/m-y.png',
        url: 'https://player.vimeo.com/video/914778828?h=a1432557e0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
    },
]
        ...
        content: (
            <div className="font-thin">
                <div className="font-medium mb-8 block">
                    Our Process for how we Manage Change
                </div>
                <p className="tracking-wide">
                    We have to provide a solution that energizes, engages, and
                    activates consumers. That overlap of consumer excitement and
                    the needs in healthcare creates an opportunity for
                    prevention that is unique and important.
                </p>
            </div>
        ),
    }
                ...
                <div className="relative">
                    <div>
                        <div className="text-white font-sans text-xl xl:mt-48 mt-8 text-center md:text-left sm:-ml-28 -ml-6 md:ml-0">
                            <div className="font-medium">Manage Change</div>
